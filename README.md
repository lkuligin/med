...
python qa/run.py --model_name=gemini-1.0-pro-001  --sample_size=1 --output_file_name=experiment1c.json --chain_type=self-refl
...
python qa/run.py --model_name=gemini-1.5-pro-001  --sample_size=1 --output_file_name=experiment2c.json --chain_type=self-refl
...
python qa/run.py --model_name=gemini-pro-experimental  --sample_size=1 --output_file_name=experiment12.json
...
python qa/run.py --model_name=anthropic_claude  --sample_size=1 --output_file_name=experiment7c.json --chain_type=self-refl 
...
python qa/run.py --model_name=gemma_2b  --sample_size=1 --output_file_name=experiment8c.json --chain_type=self-refl --max_output_tokens=2048
...
python qa/run.py --model_name=mistral_large  --sample_size=1 --output_file_name=experiment9c.json --chain_type=self-refl  
